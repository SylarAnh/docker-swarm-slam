...
static const _LocalKeyframeMatch_type_support_symbol_names_t _LocalKeyframeMatch_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cslam_common_interfaces, msg, LocalKeyframeMatch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cslam_common_interfaces, msg, LocalKeyframeMatch)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cslam_common_interfaces, msg, LocalKeyframeMatch)() {
  return &::cslam_common_interfaces::msg::rosidl_typesupport_c::LocalKeyframeMatch_message_type_support_handle;
}
