...
static const _GlobalDescriptors_type_support_symbol_names_t _GlobalDescriptors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cslam_common_interfaces, msg, GlobalDescriptors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cslam_common_interfaces, msg, GlobalDescriptors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cslam_common_interfaces, msg, GlobalDescriptors)() {
  return &::cslam_common_interfaces::msg::rosidl_typesupport_c::GlobalDescriptors_message_type_support_handle;
}
