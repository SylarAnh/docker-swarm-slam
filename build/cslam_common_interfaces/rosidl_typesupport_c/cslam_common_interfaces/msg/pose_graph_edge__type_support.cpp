...
static const _PoseGraphEdge_type_support_symbol_names_t _PoseGraphEdge_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cslam_common_interfaces, msg, PoseGraphEdge)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cslam_common_interfaces, msg, PoseGraphEdge)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cslam_common_interfaces, msg, PoseGraphEdge)() {
  return &::cslam_common_interfaces::msg::rosidl_typesupport_c::PoseGraphEdge_message_type_support_handle;
}
