...
static const _GlobalDescriptor_type_support_symbol_names_t _GlobalDescriptor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cslam_common_interfaces, msg, GlobalDescriptor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cslam_common_interfaces, msg, GlobalDescriptor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cslam_common_interfaces, msg, GlobalDescriptor)() {
  return &::cslam_common_interfaces::msg::rosidl_typesupport_c::GlobalDescriptor_message_type_support_handle;
}
