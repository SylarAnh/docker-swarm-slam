...
bool cslam_common_interfaces__msg__viz_point_cloud__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cslam_common_interfaces.msg._viz_point_cloud.VizPointCloud", full_classname_dest, 58) == 0);
  }
  cslam_common_interfaces__msg__VizPointCloud * ros_message = _ros_message;
  {  // robot_id
...
{
  /* NOTE(esteve): Call constructor of VizPointCloud */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cslam_common_interfaces.msg._viz_point_cloud");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VizPointCloud");
