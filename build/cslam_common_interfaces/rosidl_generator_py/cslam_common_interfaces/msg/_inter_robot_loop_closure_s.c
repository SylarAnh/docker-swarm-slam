...
bool cslam_common_interfaces__msg__inter_robot_loop_closure__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cslam_common_interfaces.msg._inter_robot_loop_closure.InterRobotLoopClosure", full_classname_dest, 75) == 0);
  }
  cslam_common_interfaces__msg__InterRobotLoopClosure * ros_message = _ros_message;
  {  // robot0_keyframe_id
...
{
  /* NOTE(esteve): Call constructor of InterRobotLoopClosure */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cslam_common_interfaces.msg._inter_robot_loop_closure");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InterRobotLoopClosure");
