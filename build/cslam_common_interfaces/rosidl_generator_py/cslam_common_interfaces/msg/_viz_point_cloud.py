...
class Metaclass_VizPointCloud(type):
    """Metaclass of message 'VizPointCloud'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cslam_common_interfaces.msg.VizPointCloud')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__viz_point_cloud
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__viz_point_cloud
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__viz_point_cloud
            cls._TYPE_SUPPORT = module.type_support_msg__msg__viz_point_cloud
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__viz_point_cloud
...
class VizPointCloud(metaclass=Metaclass_VizPointCloud):
    """Message class 'VizPointCloud'."""
