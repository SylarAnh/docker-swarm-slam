...
bool cslam_common_interfaces__msg__robot_ids__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cslam_common_interfaces.msg._robot_ids.RobotIds", full_classname_dest, 47) == 0);
  }
  cslam_common_interfaces__msg__RobotIds * ros_message = _ros_message;
  {  // ids
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint32_t * dest = ros_message->ids.data;
...
{
  /* NOTE(esteve): Call constructor of RobotIds */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cslam_common_interfaces.msg._robot_ids");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotIds");
  ...
  {  // ids
    ...
    if (ros_message->ids.size > 0) {
      ...
      uint32_t * src = &(ros_message->ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->ids.size * sizeof(uint32_t));
      assert(data != NULL);
