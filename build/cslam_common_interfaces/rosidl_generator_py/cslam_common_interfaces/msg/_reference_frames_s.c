...
bool cslam_common_interfaces__msg__reference_frames__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cslam_common_interfaces.msg._reference_frames.ReferenceFrames", full_classname_dest, 61) == 0);
  }
  cslam_common_interfaces__msg__ReferenceFrames * ros_message = _ros_message;
  {  // robot_id
  ...
  {  // origin_to_local
    PyObject * field = PyObject_GetAttrString(_pymsg, "origin_to_local");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__transform_stamped__convert_from_py(field, &ros_message->origin_to_local)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // frames_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "frames_id");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'frames_id'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    std_msgs__msg__String * dest = ros_message->frames_id.data;
...
{
  /* NOTE(esteve): Call constructor of ReferenceFrames */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cslam_common_interfaces.msg._reference_frames");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ReferenceFrames");
  ...
  {  // origin_to_local
    PyObject * field = NULL;
    field = geometry_msgs__msg__transform_stamped__convert_to_py(&ros_message->origin_to_local);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "origin_to_local", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // frames_id
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->frames_id.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "frames_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
