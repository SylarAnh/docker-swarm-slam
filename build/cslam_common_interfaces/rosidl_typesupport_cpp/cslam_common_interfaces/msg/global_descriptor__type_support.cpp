...
static const _GlobalDescriptor_type_support_symbol_names_t _GlobalDescriptor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cslam_common_interfaces, msg, GlobalDescriptor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cslam_common_interfaces, msg, GlobalDescriptor)),
  }
};
...
{
  return &::cslam_common_interfaces::msg::rosidl_typesupport_cpp::GlobalDescriptor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cslam_common_interfaces, msg, GlobalDescriptor)() {
  return get_message_type_support_handle<cslam_common_interfaces::msg::GlobalDescriptor>();
}
