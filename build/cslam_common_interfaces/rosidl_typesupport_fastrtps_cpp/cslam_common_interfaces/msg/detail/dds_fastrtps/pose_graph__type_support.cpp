...
#include "cslam_common_interfaces/msg/detail/pose_graph__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const cslam_common_interfaces::msg::PoseGraphEdge &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const cslam_common_interfaces::msg::PoseGraphValue &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  cslam_common_interfaces::msg::PoseGraphValue &);
size_t get_serialized_size(
  const cslam_common_interfaces::msg::PoseGraphValue &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const cslam_common_interfaces::msg::InterRobotMatches &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const cslam_common_interfaces::msg::PoseGraph & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.gps_values_idx;
  }
  // Member: gps_values
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cslam_common_interfaces::msg::PoseGraph & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
  ...
  // Member: gps_values
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.gps_values.resize(size);
    for (size_t i = 0; i < size; i++) {
      sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.gps_values[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: gps_values_idx
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.gps_values_idx[0]);
  ...
  // Member: gps_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.gps_values[index], current_alignment);
    }
  }
  // Member: nb_matches
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        cslam_common_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_PoseGraphEdge(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        cslam_common_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_PoseGraphValue(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: spectral_matches
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        cslam_common_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_InterRobotMatches(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const cslam_common_interfaces::msg::PoseGraph *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cslam_common_interfaces::msg::PoseGraph *>(
    untyped_ros_message);
...
{
  return max_serialized_size_PoseGraph(full_bounded, 0);
}
...
{
  return &cslam_common_interfaces::msg::typesupport_fastrtps_cpp::_PoseGraph__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cslam_common_interfaces, msg, PoseGraph)() {
  return &cslam_common_interfaces::msg::typesupport_fastrtps_cpp::_PoseGraph__handle;
}
