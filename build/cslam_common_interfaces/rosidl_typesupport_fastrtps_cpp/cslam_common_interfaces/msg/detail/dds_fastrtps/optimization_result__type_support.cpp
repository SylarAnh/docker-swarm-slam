...
#include "cslam_common_interfaces/msg/detail/optimization_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cslam_common_interfaces::msg::OptimizationResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cslam_common_interfaces::msg::OptimizationResult & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  // Member: estimates
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.estimates.resize(size);
    for (size_t i = 0; i < size; i++) {
      cslam_common_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.estimates[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: estimates
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        cslam_common_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.estimates[index], current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const cslam_common_interfaces::msg::OptimizationResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cslam_common_interfaces::msg::OptimizationResult *>(
    untyped_ros_message);
...
{
  return &cslam_common_interfaces::msg::typesupport_fastrtps_cpp::_OptimizationResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cslam_common_interfaces, msg, OptimizationResult)() {
  return &cslam_common_interfaces::msg::typesupport_fastrtps_cpp::_OptimizationResult__handle;
}
