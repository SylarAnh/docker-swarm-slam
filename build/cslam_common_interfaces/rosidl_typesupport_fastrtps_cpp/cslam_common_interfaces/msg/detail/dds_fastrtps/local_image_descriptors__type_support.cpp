...
#include "cslam_common_interfaces/msg/detail/local_image_descriptors__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cslam_common_interfaces::msg::LocalImageDescriptors & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cslam_common_interfaces::msg::LocalImageDescriptors & ros_message)
{
  // Member: keyframe_id
  cdr >> ros_message.keyframe_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cslam_common_interfaces
max_serialized_size_LocalImageDescriptors(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const cslam_common_interfaces::msg::LocalImageDescriptors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cslam_common_interfaces::msg::LocalImageDescriptors *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LocalImageDescriptors__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cslam_common_interfaces::msg::LocalImageDescriptors *>(
...
{
  return max_serialized_size_LocalImageDescriptors(full_bounded, 0);
}

static message_type_support_callbacks_t _LocalImageDescriptors__callbacks = {
...
static rosidl_message_type_support_t _LocalImageDescriptors__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LocalImageDescriptors__callbacks,
...
{
  return &cslam_common_interfaces::msg::typesupport_fastrtps_cpp::_LocalImageDescriptors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cslam_common_interfaces, msg, LocalImageDescriptors)() {
  return &cslam_common_interfaces::msg::typesupport_fastrtps_cpp::_LocalImageDescriptors__handle;
}
