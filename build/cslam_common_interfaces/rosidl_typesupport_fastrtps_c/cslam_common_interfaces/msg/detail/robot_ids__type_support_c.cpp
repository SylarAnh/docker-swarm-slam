...
#include "cslam_common_interfaces/msg/detail/robot_ids__rosidl_typesupport_fastrtps_c.h"
...
using _RobotIds__ros_msg_type = cslam_common_interfaces__msg__RobotIds;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RobotIds__ros_msg_type * ros_message = static_cast<const _RobotIds__ros_msg_type *>(untyped_ros_message);
  // Field name: ids
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RobotIds__ros_msg_type * ros_message = static_cast<_RobotIds__ros_msg_type *>(untyped_ros_message);
  // Field name: ids
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
    ...
    if (ros_message->ids.data) {
      rosidl_runtime_c__uint32__Sequence__fini(&ros_message->ids);
    }
    if (!rosidl_runtime_c__uint32__Sequence__init(&ros_message->ids, size)) {
...
static uint32_t _RobotIds__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cslam_common_interfaces__msg__RobotIds(
...
{
  return max_serialized_size_cslam_common_interfaces__msg__RobotIds(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_RobotIds = {
...
static rosidl_message_type_support_t _RobotIds__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RobotIds,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cslam_common_interfaces, msg, RobotIds)() {
  return &_RobotIds__type_support;
}
