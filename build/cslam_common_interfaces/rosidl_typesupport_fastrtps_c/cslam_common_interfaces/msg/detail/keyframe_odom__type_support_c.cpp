...
#include "cslam_common_interfaces/msg/detail/keyframe_odom__rosidl_typesupport_fastrtps_c.h"
...
using _KeyframeOdom__ros_msg_type = cslam_common_interfaces__msg__KeyframeOdom;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _KeyframeOdom__ros_msg_type * ros_message = static_cast<const _KeyframeOdom__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _KeyframeOdom__ros_msg_type * ros_message = static_cast<_KeyframeOdom__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
size_t get_serialized_size_cslam_common_interfaces__msg__KeyframeOdom(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _KeyframeOdom__ros_msg_type * ros_message = static_cast<const _KeyframeOdom__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _KeyframeOdom__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cslam_common_interfaces__msg__KeyframeOdom(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cslam_common_interfaces
size_t max_serialized_size_cslam_common_interfaces__msg__KeyframeOdom(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cslam_common_interfaces__msg__KeyframeOdom(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_KeyframeOdom = {
...
static rosidl_message_type_support_t _KeyframeOdom__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_KeyframeOdom,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cslam_common_interfaces, msg, KeyframeOdom)() {
  return &_KeyframeOdom__type_support;
}
