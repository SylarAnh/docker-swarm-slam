...
#include "cslam_common_interfaces/msg/detail/local_point_cloud_descriptors__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/point_cloud2__functions.h"  // data
...
using _LocalPointCloudDescriptors__ros_msg_type = cslam_common_interfaces__msg__LocalPointCloudDescriptors;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LocalPointCloudDescriptors__ros_msg_type * ros_message = static_cast<const _LocalPointCloudDescriptors__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _LocalPointCloudDescriptors__ros_msg_type * ros_message = static_cast<_LocalPointCloudDescriptors__ros_msg_type *>(untyped_ros_message);
  // Field name: keyframe_id
  {
    cdr >> ros_message->keyframe_id;
  }
...
static uint32_t _LocalPointCloudDescriptors__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cslam_common_interfaces__msg__LocalPointCloudDescriptors(
...
{
  return max_serialized_size_cslam_common_interfaces__msg__LocalPointCloudDescriptors(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_LocalPointCloudDescriptors = {
...
static rosidl_message_type_support_t _LocalPointCloudDescriptors__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LocalPointCloudDescriptors,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cslam_common_interfaces, msg, LocalPointCloudDescriptors)() {
  return &_LocalPointCloudDescriptors__type_support;
}
