...
#include "cslam_common_interfaces/msg/detail/inter_robot_loop_closure__rosidl_typesupport_fastrtps_c.h"
...
using _InterRobotLoopClosure__ros_msg_type = cslam_common_interfaces__msg__InterRobotLoopClosure;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _InterRobotLoopClosure__ros_msg_type * ros_message = static_cast<const _InterRobotLoopClosure__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _InterRobotLoopClosure__ros_msg_type * ros_message = static_cast<_InterRobotLoopClosure__ros_msg_type *>(untyped_ros_message);
  // Field name: robot0_keyframe_id
  {
    cdr >> ros_message->robot0_keyframe_id;
  }
...
size_t get_serialized_size_cslam_common_interfaces__msg__InterRobotLoopClosure(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InterRobotLoopClosure__ros_msg_type * ros_message = static_cast<const _InterRobotLoopClosure__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _InterRobotLoopClosure__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cslam_common_interfaces__msg__InterRobotLoopClosure(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cslam_common_interfaces
size_t max_serialized_size_cslam_common_interfaces__msg__InterRobotLoopClosure(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cslam_common_interfaces__msg__InterRobotLoopClosure(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_InterRobotLoopClosure = {
...
static rosidl_message_type_support_t _InterRobotLoopClosure__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_InterRobotLoopClosure,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cslam_common_interfaces, msg, InterRobotLoopClosure)() {
  return &_InterRobotLoopClosure__type_support;
}
