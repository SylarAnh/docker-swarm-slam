...
class Metaclass_LocalDescriptorsRequest(type):
    """Metaclass of message 'LocalDescriptorsRequest'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__local_descriptors_request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__local_descriptors_request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__local_descriptors_request
            cls._TYPE_SUPPORT = module.type_support_msg__msg__local_descriptors_request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__local_descriptors_request
...
class LocalDescriptorsRequest(metaclass=Metaclass_LocalDescriptorsRequest):
    """Message class 'LocalDescriptorsRequest'."""
