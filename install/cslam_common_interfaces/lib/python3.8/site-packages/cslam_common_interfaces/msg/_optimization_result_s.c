...
bool cslam_common_interfaces__msg__optimization_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cslam_common_interfaces.msg._optimization_result.OptimizationResult", full_classname_dest, 67) == 0);
  }
  cslam_common_interfaces__msg__OptimizationResult * ros_message = _ros_message;
  {  // success
  ...
  {  // factors
    ...
    cslam_common_interfaces__msg__PoseGraphEdge * dest = ros_message->factors.data;
  ...
  {  // estimates
    PyObject * field = PyObject_GetAttrString(_pymsg, "estimates");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'estimates'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    cslam_common_interfaces__msg__PoseGraphValue * dest = ros_message->estimates.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * cslam_common_interfaces__msg__optimization_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cslam_common_interfaces.msg._optimization_result");
  ...
  {  // estimates
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->estimates.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "estimates", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
