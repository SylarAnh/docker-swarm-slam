...
bool cslam_common_interfaces__msg__keyframe_odom__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cslam_common_interfaces.msg._keyframe_odom.KeyframeOdom", full_classname_dest, 55) == 0);
  }
  cslam_common_interfaces__msg__KeyframeOdom * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of KeyframeOdom */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cslam_common_interfaces.msg._keyframe_odom");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KeyframeOdom");
