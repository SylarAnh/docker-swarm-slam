...
bool cslam_common_interfaces__msg__pose_graph_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cslam_common_interfaces.msg._pose_graph_value.PoseGraphValue", full_classname_dest, 60) == 0);
  }
  cslam_common_interfaces__msg__PoseGraphValue * ros_message = _ros_message;
  {  // key
    PyObject * field = PyObject_GetAttrString(_pymsg, "key");
    if (!field) {
      return false;
    }
    if (!cslam_common_interfaces__msg__multi_robot_key__convert_from_py(field, &ros_message->key)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of PoseGraphValue */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cslam_common_interfaces.msg._pose_graph_value");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseGraphValue");
  ...
  {  // key
    PyObject * field = NULL;
    field = cslam_common_interfaces__msg__multi_robot_key__convert_to_py(&ros_message->key);
    if (!field) {
      return NULL;
    }
    {
