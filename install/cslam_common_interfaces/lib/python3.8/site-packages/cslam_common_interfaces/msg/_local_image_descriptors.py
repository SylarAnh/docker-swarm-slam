...
class Metaclass_LocalImageDescriptors(type):
    """Metaclass of message 'LocalImageDescriptors'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__local_image_descriptors
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__local_image_descriptors
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__local_image_descriptors
            cls._TYPE_SUPPORT = module.type_support_msg__msg__local_image_descriptors
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__local_image_descriptors
...
class LocalImageDescriptors(metaclass=Metaclass_LocalImageDescriptors):
    """Message class 'LocalImageDescriptors'."""
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('uint32')),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'msg'], 'RGBDImage'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from rtabmap_msgs.msg import RGBDImage
        self.data = kwargs.get('data', RGBDImage())
    ...
    def data(self, value):
        if __debug__:
            from rtabmap_msgs.msg import RGBDImage
            assert \
                isinstance(value, RGBDImage), \
                "The 'data' field must be a sub message of type 'RGBDImage'"
        self._data = value
